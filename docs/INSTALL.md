...
13. Placer la source au-dessus de la capture du jeu, vérifier le fond transparent et les rouleaux en relançant la démo. Pour tester l’animation, OBS doit être déjà ouvert quand les valeurs augmentent. À l’ouverture initiale le chiffre se place directement, volontairement.
